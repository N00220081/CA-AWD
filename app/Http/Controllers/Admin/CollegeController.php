    ...
    public function update(Request $request, College $college)
{
    ...
    return to_route('admin.colleges.show', $college)->with('success','College updated successfully');
}
    ...
    public function destroy(string $id)
{
    ...
    $college->delete();
    return to_route('admin.colleges.index')->with('success', 'College successfully removed');
}
}
